...
locations = ['DNK', 'DEU', 'ISL', 'JPN', 'FRA', 'HUN',
             'POL', 'ESP', 'GRC', 'IRL', 'KOR', 'MEX', 'NOR', 'ITA']

indx = np.arange(len(locations))

percentage_label = np.arange(0, 100, 10)

perc_2007 = [82.960, 78.647, 89.150, 85.000, 65.549, 52.565,
             53.689, 58.949, 40.167, 65.487, 80.447, 22.120, 82.417, 53.380]

perc_2017 = [93.137, 92.866, 97.297, 72.500, 84.125, 79.675,
             81.777, 78.385, 70.500, 83.758, 74.708, 45.419, 94.906, 72.502]
